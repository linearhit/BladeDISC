...
struct DiscSpecializeFusionWithSpeculationPass
  ...
  void DoBroadcastSpeculation(FusionOp fusion_op) {
    ...
    for (Operation* op : broadcast_ops) {
      ...
      for (int i = 0; i < rank; ++i) {
        ...
        Value eq = b.create<arith::CmpIOp>(loc, arith::CmpIPredicate::eq, lhs, rhs);
  ...
  void DoRowReductionSpeculation(FusionOp fusion_op) {
    ...
    Value pred = b.create<arith::CmpIOp>(loc, arith::CmpIPredicate::sgt, col_size, ref_size);
  ...
  void DoColReductionSpeculation(FusionOp fusion_op) {
    ...
    Value pred =
        b.create<arith::CmpIOp>(loc, arith::CmpIPredicate::sgt, cur_blocks, ref_blocks);
  ...
  void DoVectorizationSpeculation(FusionOp fusion_op) {
    ...
    Value larger = b.create<arith::CmpIOp>(loc, arith::CmpIPredicate::sgt, out_element_number,
                                    threshold);
    Value is_even =
