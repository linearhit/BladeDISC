...
struct DiscLowerGpuOpsToNVVMOpsPass
  ...
  void runOnOperation() override {
    ...
    SmallVector<std::string> disablePatterns = {
        "mlir::VectorConvertToLLVMPattern<mlir::math::AbsOp, mlir::LLVM::FAbsOp>",
        "mlir::VectorConvertToLLVMPattern<mlir::math::CeilOp, mlir::LLVM::FCeilOp>",
        "mlir::VectorConvertToLLVMPattern<mlir::math::CosOp, mlir::LLVM::CosOp>",
        "mlir::VectorConvertToLLVMPattern<mlir::math::ExpOp, mlir::LLVM::ExpOp>",
        "mlir::VectorConvertToLLVMPattern<mlir::math::Exp2Op, mlir::LLVM::Exp2Op>",
        "{anonymous}::ExpM1OpLowering",
        "mlir::VectorConvertToLLVMPattern<mlir::math::FloorOp, mlir::LLVM::FFloorOp>",
        "mlir::VectorConvertToLLVMPattern<mlir::math::Log10Op, mlir::LLVM::Log10Op>",
        "{anonymous}::Log1pOpLowering",
        "mlir::VectorConvertToLLVMPattern<mlir::math::Log2Op, mlir::LLVM::Log2Op>",
        "mlir::VectorConvertToLLVMPattern<mlir::math::LogOp, mlir::LLVM::LogOp>",
        "mlir::VectorConvertToLLVMPattern<mlir::math::PowFOp, mlir::LLVM::PowOp>",
        "{anonymous}::RsqrtOpLowering",
        "mlir::VectorConvertToLLVMPattern<mlir::math::SinOp, mlir::LLVM::SinOp>",
        "mlir::VectorConvertToLLVMPattern<mlir::math::SqrtOp, mlir::LLVM::SqrtOp>"
    };
    ...
    auto llvmFrozenPatterns = FrozenRewritePatternSet(std::move(llvmPatterns),
                                                      disablePatterns, {});
