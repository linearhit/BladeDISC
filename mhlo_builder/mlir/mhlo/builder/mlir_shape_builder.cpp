...
mlir::Value BuildShapeOfTensor(mlir::OpBuilder& builder,
  ...
  mlir::Value shape = builder.create<mlir::tensor::FromElementsOp>(loc, shape_values);
  return shape;
}
...
mlir::Value BuildDynamicReshapeTensor(mlir::OpBuilder& builder,
  ...
  mlir::Value shape = builder.create<mlir::tensor::FromElementsOp>(loc, new_shape_vals);
...
mlir::Value BuildFromElements(mlir::OpBuilder& builder,
  ...
  // rank 0.
  mlir::Value shape =
      builder.create<mlir::tensor::FromElementsOp>(loc, scalar);
